...
class Emitter:
    ...
    def __str__(self) -> str:
        ...
        C: 256THz, South
        '''
        # Mapping from direction character to full word
        direction_map = {'N': 'North', 'E': 'East', 'S': 'South', 'W': 'West'}

        # Handling the case where direction might be None
        full_direction = direction_map.get(self.direction, 'None')

        return f"{self.symbol}: {self.frequency}THz, {full_direction}"
